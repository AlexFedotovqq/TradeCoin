...
const posts = [
  ...
  },
  {
    ...
    href: "/blogs/access",
    category: { name: "Article", href: "#" },
    description: "Download MetaMask wallet from the App Store or Google Play.",
    date: "Jan 16, 2022",
    datetime: "2022-01-16",
    imageUrl:
...
export default function Example() {
  return (
    <div className="relative bg-gradient-to-b from-indigo-200 to-indigo-500 px-6 pt-16 pb-20 lg:px-8 lg:pt-24 lg:pb-28">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-xl text-gray-900 sm:mt-4">
            <strong>
              {" "}
              Here you can read our posts and learn something new and
              interesting.
            </strong>
          </p>
        </div>

      ...
      <div className="relative px-6 lg:px-8">
        <div className="mx-auto max-w-prose text-lg">
          <h1>
            ...
            If your custom (unlisted) tokens are not showing up automatically in MetaMask's assets area, this article will explain how to add them.
          </p>
          <p className="mt-8 text-3xl font-bold leading-8 tracking-tight text-gray-900 sm:text-4xl">
          ...
          <div className="mt-5 relative overflow-hidden  flex items-center justify-center">
            ...
            <li>5. Insert the contract address of the token to the field Token Contract Address. The token symbol and token decimal will get filled automatically. You can edit it if needed.</li>
          ...
          <div className="mt-5 relative overflow-hidden  flex items-center justify-center">
            ...
            <li>6. Click Add Custom Token. You will see the token information and the balance (if you have these tokens at your address).</li>
          ...
          <div className="mt-5 relative overflow-hidden  flex items-center justify-center">
            ...
            <li>7. Click Import Tokens. Congratulations, you added the custom token to MetaMask and it will become visible in the Assets tab in MetaMask.</li>

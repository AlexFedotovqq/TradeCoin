...
export default function Example() {
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-indigo-200 to-indigo-500 py-16">
      ...
      <div className="relative px-6 lg:px-8">
        <div className="mx-auto max-w-prose text-lg">
          ...
          <ul role="list">
            <li>1. Download MetaMask wallet from the App Store or Google Play.</li>
            <li>2. Create and confirm your MetaMask wallet by following the instructions provided.</li>
            <li>3. Now, you need to connect your wallet to the XDC network. To do this, click on the three dots in the top right corner of the MetaMask wallet and select ‘Settings’.</li>
            <li>4. In the ‘Networks’ tab, select ‘Add Network’.</li>
            <li>5.Enter the following details in the ‘Add Network’ form</li>
            <li> <strong>Network Name: XDC</strong></li>
            <li> <strong>New RPC URL: <a href="https://rpc.xinfin.network">https://rpc.xinfin.network</a></strong></li>
            <li> <strong>ChainID: 50</strong></li>
            <li> <strong>Symbol: XDC</strong></li>
            <li> <strong>Block Explorer URL: <a href="https://scan.xinfin.network">https://scan.xinfin.network</a></strong></li>
            <li>6. Click on ‘Save’.</li>
            <li>7. Now, click on ‘Home’ and select ‘Accounts’ from the menu.</li>
            <li>8. Click on ‘Import Account’ and select the ‘Private Key’ option.</li>
            <li>9. Enter your XDC account’s private key and click ‘Import’.</li>
        ...
        <div className="mx-auto mt-10 flex max-w-prose text-base lg:max-w-none">
                ...
                <Link href="/blogs"
                                    className="flex w-full items-center justify-center rounded-md border border-transparent bg-pink-500 px-5 py-3 text-base font-medium text-white hover:bg-pink-700"
